...
impl GamdStatsWriter {
    ...
    pub fn new(path: &str, title: &str) -> Result<Self, String> {
        ...
        // Write header
        writeln!(writer, "# {}", title).map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(writer, "# GaMD Statistics File")
            .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(writer, "#").map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(writer, "# Columns:").map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(writer, "# Step      : MD step number")
            .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# V_dih     : Current dihedral potential energy (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# V_tot     : Current total potential energy (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# V_max_dih : Maximum dihedral energy observed (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# V_min_dih : Minimum dihedral energy observed (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        ...
        writeln!(
            writer,
            "# σ_dih     : Standard deviation of dihedral energy (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# V_max_tot : Maximum total energy observed (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# V_min_tot : Minimum total energy observed (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        ...
        writeln!(
            writer,
            "# σ_tot     : Standard deviation of total energy (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# k_dih     : GaMD boost coefficient for dihedral (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# k_tot     : GaMD boost coefficient for total (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# E_dih     : GaMD threshold energy for dihedral (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# E_tot     : GaMD threshold energy for total (kJ/mol)"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(writer, "#").map_err(|e| format!("Failed to write header: {}", e))?;
    ...
    pub fn finalize(&mut self) -> Result<(), String> {
        self.flush()?;
        writeln!(self.writer, "# END").map_err(|e| format!("Failed to write END marker: {}", e))?;
        self.flush()
    }
}
...
impl GamdBoostWriter {
    ...
    pub fn new(path: &str, title: &str) -> Result<Self, String> {
        ...
        writeln!(
            writer,
            "# This file contains the boost potential ΔV at each MD step"
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(
            writer,
            "# for reweighting analysis to recover unbiased free energies."
        )
        .map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(writer, "#").map_err(|e| format!("Failed to write header: {}", e))?;
        writeln!(writer, "# Columns:").map_err(|e| format!("Failed to write header: {}", e))?;
...
mod tests {
    use super::*;
    use gromos_integrators::gamd::{BoostForm, SearchMode, ThresholdType};
    use std::fs;
