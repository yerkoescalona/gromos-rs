...
config = gromos.Configuration(num_atoms=num_atoms, num_temp_groups=1, num_energy_groups=1)
print(f"\n{config}")
...
gamma = 0.1  # ps^-1
integrator_sd = gromos.StochasticDynamics(dt=timestep, gamma=gamma, temperature=temperature)
