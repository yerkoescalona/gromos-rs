...
fn test_mk_script_basic_generation() {
    ...
    let imd_content = fs::read_to_string("/tmp/test_mk.imd").expect("Failed to read generated IMD");
...
fn test_mk_script_custom_parameters() {
    ...
    let imd_content = fs::read_to_string("/tmp/test_custom.imd").expect("Failed to read IMD");
...
fn test_mk_script_pressure_coupling() {
    ...
    let imd_content = fs::read_to_string("/tmp/test_press.imd").expect("Failed to read IMD");
...
fn test_mk_script_reaction_field_settings() {
    ...
    let imd_content = fs::read_to_string("/tmp/test_rf.imd").expect("Failed to read IMD");
...
fn test_mk_script_output_frequencies() {
    ...
    let imd_content = fs::read_to_string("/tmp/test_freq.imd").expect("Failed to read IMD");
