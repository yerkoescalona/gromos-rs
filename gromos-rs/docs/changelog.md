...
### Known Issues
- ⚠️ ~140+ compilation errors with all features enabled
- ⚠️ Missing type definitions (CudaError → DriverError needed fixing)
- ⚠️ Incomplete PME/MPI implementations
- ⚠️ Unfinished EDS/REMD functionality
- ⚠️ No validation against GROMOS reference implementations

### Removed
- 🗑️ Legacy C++ code (md++, gromosPlusPlus) - 1.5M lines removed
- 🗑️ 22 outdated planning/analysis markdown files - 8,800 lines removed
- 🗑️ Unused test_tutorial and tutorial_files directories
- 🗑️ Empty /docs directory (moved to gromos-rs/docs/)
...
[Unreleased]: https://github.com/yerkoescalona/gromosXX/tree/main
